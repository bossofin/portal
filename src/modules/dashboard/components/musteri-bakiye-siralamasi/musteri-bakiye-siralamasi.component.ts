...
@Component({
  selector: 'app-musteri-bakiye-siralamasi',
  templateUrl: './musteri-bakiye-siralamasi.component.html',
  styleUrls: ['./musteri-bakiye-siralamasi.component.scss'],
})
export class MusteriBakiyeSiralamasiComponent implements OnInit {
  dataSource = [
